...
if __name__ == '__main__':
    ...
    # 获取每个视频帧数
    with open("/data2/zww/abaw/testset/test_set_examples/CVPR_5th_ABAW_AU_test_set_example.txt","r") as f:
        lines = f.readlines()
        for line in lines[1:]:
            t = line.split("/")[0]
    ...
    # 获取视频列表
    test_label = "/data2/zww/abaw/testset/names_of_videos_in_each_test_set/Action_Unit_Detection_Challenge_test_set_release.txt"
    test_videos = []
    ...
    with open(save_path,"w") as f:
        ...
        for test_video in tqdm(test_videos):
            ...
            for i in range(frames_length):
                ...
                f.write(test_video+"/"+str(i+1).zfill(5)+".jpg,"+write_str+"\n")
