...
label_root_dir = "label/VA_Estimation_Challenge/"
video_dir = "video"
features_dir = "features"
align_dir = "align"
sample_root_dir = "/data1/zww/abaw/samples3"
...
for mod in mods:
    ...
    for label_file in tqdm(label_files):
        ...
        np.savez(save_path, select_wav_base_features=select_wav_base_features, select_wav_emotion_features=select_wav_emotion_features,
                 ...
                 select_affecnet8_features=select_affecnet8_features,select_valences=select_valences, select_arousals=select_arousals)
